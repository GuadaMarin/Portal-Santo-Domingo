      ...
      <IonContent fullscreen className="ion-padding">
        <IonGrid fixed>
          <IonRow>
            ...
            <IonCol size="12" sizeMd="4">
              <IonCard className="glass-panel hover:bg-green-50" button routerLink="/servicios?tipo=untos-reciclaje">
                <IonCardHeader>
          ...
          <IonRow>
            ...
            <IonCol size="12" sizeMd="6">
              <IonCard className="glass-panel hover:bg-green-50" button routerLink="/servicios?tipo=zonas-verdes">
                <IonCardHeader>
